...
# Alpine binaries have NEEDED: libc.musl-x86_64.so.1, but Hadron installs musl as /usr/lib/libc.so
RUN ln -sf /lib/ld-musl-x86_64.so.1 /usr/lib/libc.musl-x86_64.so.1 || \
    ln -sf /lib/ld-musl-aarch64.so.1 /usr/lib/libc.musl-aarch64.so.1 || true
